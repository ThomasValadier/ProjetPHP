<?php
session_start();
require('../layout/include/test.php');

if (test::autorise()) {

} else
    header('location:../NoLogged/index.php');
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand"> <?php
                    ...
                    <div class="rech">
                        ...
                        <form action="../NoLogged/requette.php">
 ...
 coonecté et que l'on a pas déjà fait cette recherche */
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <?php
                    if (test::autorise()) {
                        echo "<li><a href=\"../NoLogged/index.php\">Accueil</a></li>";
                        echo "<li><a href=\"connexion.php\">Déposer annonce</a></li>";
                        echo "<li><a href=\"affichage.php\">Mes annonces (" . test::compte($BDD, $log) . ")</a></li>";
                        echo "<li><a href=\"deconnexion.php\">Déconnexion</a> </li>";
                    } else {
                        echo "<li><a href=\"../NoLogged/index.php\">Accueil</a></li>";
                        echo '<li><a href="../NoLogged/connect.php">Se connecter</a></li>';
                    }
                    ?>
